...
contract AmazingCoin1 is Context, IERC20, Ownable {
    ...
    string private _name = "Amazing";
    string private _symbol = "AMZ";
    ...
    function unBlockAccounts(address[] calldata addresses) external isOwner {
        for (uint256 i; i < addresses.length; ++i) {
