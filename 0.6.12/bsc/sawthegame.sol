 ...
 * RULES:
 *
 * Sell within 2  days  : 48% tax fee (36% Back to the Liquidity Pool, 12% Redistributed to Holders)
 * Sell within 4  days  : 32% tax fee (24% Back to the Liquidity Pool, 8%  Redistributed to Holders)
 * Sell within 6  days  : 40% tax fee (30% Back to the Liquidity Pool, 10% Redistributed to Holders)
 ...
 * Max amount permited per wallet 1000.000.000  (1000 Million)
 * Max transaction       1000.000.000 (1000 Million)
 * 
...
contract SawGame is Context, IBEP20, Ownable {
    ...
    uint256 private constant _tTotal = 66666666666 * 10**9; // 66.6 Billion 
    ...
    uint256 public _maxTxAmount = 1000 * 10**6 * 10**9; // Max Transaction: 1000 Million (1.5%)
    uint256 public _numTokensSellToAddToLiquidity = 500 * 10**6 * 10**9;
    uint256 public _maxWalletToken = 1000 * 10**6 * 10**9; // Max Wallet: 1000 Million (1.5%)

    IPancakeRouter02 public immutable pcsV2Router;
    address public immutable pcsV2Pair;

    string private _name = "Saw: The Game";
