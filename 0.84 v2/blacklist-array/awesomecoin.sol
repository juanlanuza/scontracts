...
contract AwesomeCrypto1 is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public charityAddress = payable(0xFB3c41738c2db5E4928e8F86E05bD7EB0Dc44939); // Charity Address
    ...
    string private _name = "Awesome Crypto 1";
    string private _symbol = "AC1";
    uint8 private _decimals = 8;

    uint256 public _taxFee = 4;
    uint256 private _previousTaxFee = _taxFee;

    uint256 public _liquidityFee = 6; // 3% for charity and 3% for liquidity
    uint256 private _previousLiquidityFee = _liquidityFee;

    uint256 public _maxTxAmount = 5000000 * 10**6 * 10**8;
    uint256 private minimumTokensBeforeSwap = 500000 * 10**6 * 10**8; 
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        // split the contract balance into liquidity and charity amounts
        uint256 liquidityAmount = contractTokenBalance.div(2);
